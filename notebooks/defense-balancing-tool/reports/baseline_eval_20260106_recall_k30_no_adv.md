...
- acc       mean=0.5128 min=0.4359 max=0.5897
- bal_acc   mean=0.5022 min=0.4444 max=0.5794
- f1_1      mean=0.2984 min=0.0000 max=0.6316
- recall_1  mean=0.3648 min=0.0000 max=1.0000
- prec_1    mean=0.3610 min=0.0000 max=1.0000
- ap        mean=0.4850 min=0.4067 max=0.5520
- roc_auc   mean=0.4854 min=0.3889 max=0.5794
- thr       mean=0.1973 min=0.0500 max=0.4300

### Final Model (fit on FULL train)
- thr: 0.2050
- thr_repeats_mean: 0.1973
- thr_repeats_median: 0.2050
- test metrics:
  - acc: 0.5385
  - bal_acc: 0.5000
  - f1_1: 0.0000
