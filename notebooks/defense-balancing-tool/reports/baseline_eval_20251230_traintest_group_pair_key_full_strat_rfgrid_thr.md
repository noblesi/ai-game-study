...
- acc       mean=0.7667 min=0.5385 max=0.9231
- bal_acc   mean=0.7675 min=0.5000 max=0.9286
- f1_1      mean=0.6776 min=0.0000 max=0.9231
- recall_1  mean=0.7778 min=0.0000 max=1.0000
- prec_1    mean=0.6129 min=0.0000 max=0.9412
- ap        mean=0.9257 min=0.8352 max=0.9837
- roc_auc   mean=0.9476 min=0.9008 max=0.9841
- thr       mean=0.1640 min=0.0500 max=0.4400

### Final Model (fit on FULL train)
- thr: 0.1200
- thr_repeats_mean: 0.1640
- thr_repeats_median: 0.1200
- test metrics:
  - acc: 0.8205
  - bal_acc: 0.8333
  - f1_1: 0.8372
