...
- C: 1.0
- tune_threshold: False (metric=f1)
- threshold stats: mean=0.650 min=0.650 max=0.650

### Metrics / TEST
- acc       mean=0.9199 min=0.8309 max=0.9706
- bal_acc   mean=0.8816 min=0.6802 max=0.9505
- f1_1      mean=0.7645 min=0.5000 max=0.9024
- recall_1  mean=0.8256 min=0.3953 max=0.9535
- prec_1    mean=0.7285 min=0.4776 max=0.9487
- ap        mean=0.8104 min=0.5901 max=0.9619
- roc_auc   mean=0.9571 min=0.9043 max=0.9913
- thr       mean=0.6500 min=0.6500 max=0.6500

### Confusion Matrix (sum over repeats)
- TN=42940 FP=2860 FN=1500 TP=7100
